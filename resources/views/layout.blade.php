...
<body>
                    ...
                    <div class="col-sm-12">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> +01010101 </a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> Team12@gmail.com </a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="/shop/trang-chu"> TEAM 12 </a>
                        </div>
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <div class="col-sm-6">
                                    <h1><span style="color:red">Chanel</span>Fashions</h1>
                                    <h2>Thời Trang</h2>
                                    <p>Thương Hiệu Dành Cho Phụ Nữ </p>
                                    <button type="button" class="btn btn-default get">Thông tin</button>
                                </div>
                                <div class="col-sm-6">
                                    <img src="https://image.bnews.vn/MediaUpload/Org/2019/03/02/143959_bieu-tuong-nganh-thoi-trang-the-gioi-karl-lagerfeld-qua-doi.jpg"
                            ...
                            <div class="item">
                                <div class="col-sm-6">
                                    <h1><span style="color:green">Luois </span>Vuitton</h1>
                                    <h2>Thời Trang</h2>
                                    <p>Thời trang dành cho quý ông</p>
                                    <button type="button" class="btn btn-default get">Thông tin</button>
                                </div>
                                <div class="col-sm-6">
                                    <img src="https://vcdn-giaitri.vnecdn.net/2020/03/03/Louis-Vuitton-Monogram-Speedy-3945-9134-1583222597.jpg"
                                        style="width:490px;height:400px;" class="girl img-responsive" alt="Slider" />
                                    <!-- <img src="images/home/pricing.png" class="pricing" alt="" /> -->
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-sm-6">
                                    <h1><span style="color:blue">Adidas</span>Sport</h1>
                                    <h2>Thể Thao</h2>
                                    <p>Thương hiệu dành cho những ngươi thích trải nghiệm </p>
                                    <button type="button" class="btn btn-default get">Thông tin</button>
                                </div>
                                <div class="col-sm-6">
                                    <img src="https://cdn.tgdd.vn/Files/2017/09/15/1021837/cach-ve-sinh-giay-adidas-dung-chuan-do-hang-huong-dan-202107221541316667.jpg" alt="Slider"
                                        style="width:490px;height:400px;" class="girl img-responsive" alt="Slider" />
                                    <!-- <img src="images/home/pricing.png" class="pricing" alt="" /> -->
                                </div>
                            </div>
    ...
    <footer id="footer">
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Copyright © 2022 Team 12 Inc. All rights reserved.</p>
